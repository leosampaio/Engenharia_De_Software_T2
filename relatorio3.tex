...
\section{Testes}
	...
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{|c|X|X|X|X|X|X|} \hline
			...
			4 & Sequência A2 - Senha inválida & Formato Válido & Data Válida & Formato Inválido & Conf Senha = Senha & Cadastro não realizado\\ \hline
			5 & Sequência A2 - Conf de senha errada & Formato Válido & Data Válido & Formato Válido & Conf Senha != Senha & Cadastro não realizado\\ \hline
	...
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{|c|X|X|X|X|X|} \hline
			...
			4 & Sequência A2 - Descrição inválida & Formato Válido & Plataforma Válida & Formato Inválido & Jogo não incluso\\ \hline
	...
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{|c|X|X|X|X|X|} \hline
			...
			2 & Sequência Típica - Senha antiga incorreta & Senha != Senha Antiga & Formato Válido & Conf senha = Senha nova & Senha não alterada \\ \hline
			3 & Sequência Típica - Nova senha inválida & Senha = Senha Antiga & Formato Inválido & Conf senha = Senha nova & Senha não alterada \\ \hline
			4 & Sequência Típica - Conf senha incorreta & Senha = Senha Antiga & Formato Válido & Conf senha != Senha nova & Senha não alterada \\ \hline
	...
	\begin{table}[H]
		\begin{tabularx}{\textwidth}{|c|X|X|X|X|} \hline
			...
			2 & Sequência Típica - E-mail não existente & E-mail não existente & Senha correta & Login não executado\\ \hline
			3 & Sequência Típica - Senha incorreta & E-mail existente & Senha Incorreta & Login não executado\\ \hline
